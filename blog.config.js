...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Sharing of IELTS speaking questions & high score answers, personalized answers can be customized',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'krisyu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a person who love to share and explore', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://speaking-ielts.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'IELTS,ielts,ielts speaking,speaking ielts,雅思', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'a5c799a81a870d9a3db2e0a6897a9573', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-G4NGTT5GWJ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
